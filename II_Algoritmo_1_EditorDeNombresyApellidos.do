...
/*
	local codestrext "################################!##$%&'()*+,-./0123456789:;<=>?@##########################[\]^_`##########################{|}~€‚ƒ„…†‡ˆ‰Š‹ŒŽ ‘’“”•–—˜™š›œžŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐ#ÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþ#"
	dis "`codestrext'"
	/*local i = 1
...
************************************************************************************************************	
	...
	*replace NameProv= subinstr(NameProv,"XYZ","",1)
	...
	replace NameProv= subinstr(NameProv,"ý","Ñ",2) if regexm(NameProv,"[AEIOU]ý[AEIOU]")==1
	replace NameProv= subinstr(NameProv,"ý","A",2) if regexm(NameProv,"[AEIOU]ý[AEIOU]")==0
